...
class HVACVisualizer(StateViz):
    ...
    def render_zone(self, zone: str) -> tuple:
        ...
        temp_rect = plt.Rectangle((init_x, init_y), interval, 
                                  temp / 100 * interval, fc='crimson', zorder=3)
        ...
        plt.text(init_x + interval * 0.8, init_y + interval * 0.8, 
                 "%s" % curr_z, color='black', fontsize=5, zorder=5)
    ...
    def render_heater(self, heater: str) -> tuple:
        ...
        plt.text(init_x + interval * 0.8, init_y + interval * 0.8, 
                 "%s" % curr_h, color='black', fontsize=5, zorder=5)
