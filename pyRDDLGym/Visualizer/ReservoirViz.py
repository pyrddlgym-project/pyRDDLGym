...
class ReservoirVisualizer(StateViz):
    def __init__(self, model: PlanningModel, grid_size: Optional[int] = [50,50], resolution: Optional[int] = [500,500]) -> None:
    ...
    def render_res(self, res : str) -> tuple:
        ...
        shape_rect = plt.Rectangle((init_x, init_y + interval), interval, interval/4, fc='darkcyan', alpha=rain_shape/50)
